      ...
      <form onSubmit={handleSaveSettings} className="space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-2xs space-y-4">
          <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
            ...
            <h2 className="text-sm font-bold text-slate-900">APMC Mandi Yard Information</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div>
              <label className="block font-bold text-gray-700 mb-1.5">Official Mandi Yard Name</label>
              <input
                type="text"
                value={mandiName}
                onChange={(e) => setMandiName(e.target.value)}
                placeholder="e.g. APMC Market Yard Indore"
                className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white transition"
              />
            </div>

            <div>
              <label className="block font-bold text-gray-700 mb-1.5">APMC License / Registration Code</label>
              <input
                type="text"
                value={apmcCode}
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-2xs space-y-5">
          <div className="flex items-center justify-between border-b border-gray-100 pb-3 flex-wrap gap-2">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-slate-900">Physical Yard Address &amp; Location Markup</h2>
            </div>
            <button
              type="button"
          ...
          <div className="space-y-4 text-xs">
            <div>
              <label className="block font-bold text-gray-700 mb-1.5">Physical Yard Street Address</label>
              <textarea
                rows={2}
                value={yardAddress}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label className="block font-bold text-gray-700 mb-1.5">District</label>
                <input
                  type="text"
                  value={district}
                  onChange={(e) => setDistrict(e.target.value)}
                  placeholder="e.g. Indore"
                  className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white transition"
                />
              </div>

              <div>
                <label className="block font-bold text-gray-700 mb-1.5">State</label>
                <input
                  type="text"
                  value={state}
              ...
              <div>
                <label className="block font-bold text-gray-700 mb-1.5">Postal PIN Code</label>
                <input
                  type="text"
                  maxLength={6}
                  value={pinCode}
            ...
            <div className="pt-3 border-t border-gray-100 space-y-3">
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="font-mono text-xs font-bold text-emerald-700 bg-emerald-50 px-2 py-1 rounded-lg border border-emerald-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block font-semibold text-gray-600 mb-1 text-[11px]">
                    Latitude
                  </label>
                  <input
                    type="number"
                    ...
                    className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-mono font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 focus:bg-white transition"
                  />
                </div>
                <div>
                  <label className="block font-semibold text-gray-600 mb-1 text-[11px]">
              ...
              <div className="relative rounded-xl overflow-hidden border border-slate-200 h-56 bg-slate-100 shadow-inner">
                <iframe
                  ...
                  loading="lazy"
                />
                <div className="absolute bottom-2 right-2 bg-white/95 backdrop-blur-xs px-2.5 py-1 rounded-lg border border-slate-200 text-[10px] font-bold text-slate-700 flex items-center gap-1.5 shadow-2xs">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-2xs space-y-4">
          <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
            ...
            <h2 className="text-sm font-bold text-slate-900">Operating Schedule &amp; Mandi Timing</h2>
          </div>
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 mt-1">Farmer arrival booking slots will be disallowed during these hours.</p>
              </div>
            </div>
          </div>
        </div>
